...
export default function CommentSection({ postId }: { postId: string }) {
  ...
  return (
    <section className="border-dashed border-[#353535]/30 dark:border-[#353535] border w-full lg:max-w-[70%] mx-auto px-4 lg:px-8">
      <Form {...form}>
        <form
        ...
        >
          <FormField
            ...
            name="name"
            render={({ field }) => (
              <FormItem className="mx-auto w-full lg:max-w-3/5">
      ...
      <div className="w-full lg:w-3/5 py-10 mx-auto">
        {loading ? (
